...
/* -----------------------------------------------wj additions------------------------------------------------ */				
	$("#song_description").html(this.playlist[this.current].title); 	// Display current song title in "#song_description" DIV				
...
/* -----------------------------Drop down Menu----------------------------- */
jQuery(function($){
  $('#songImage, #playerControls, .jp-playlist').click(function(e){	// select DIVs by Id (#) or Class (.) and Detect if click occured then close menu
